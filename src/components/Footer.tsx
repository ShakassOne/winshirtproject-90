...
const Footer: React.FC = () => {
  return (
    <footer className="border-t border-winshirt-purple/20 backdrop-blur-md bg-winshirt-space/80 text-white">
      <div className="container mx-auto py-12 px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-300">
              Portez votre style, tentez votre chance !
              Un concept innovant qui allie mode et loterie.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-300 hover:text-winshirt-blue-light">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li>
                <Link to="/" className="hover:text-winshirt-blue-light">Accueil</Link>
              </li>
              <li>
                <Link to="/products" className="hover:text-winshirt-blue-light">Nos T-shirts</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li>
                <Link to="/how-it-works" className="hover:text-winshirt-blue-light">Comment ça marche</Link>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 border-t border-winshirt-purple/20 text-center text-sm text-gray-400">
          <p>&copy; {new Date().getFullYear()} WinShirt. Tous droits réservés.</p>
        </div>
      </div>
    </footer>
  );
